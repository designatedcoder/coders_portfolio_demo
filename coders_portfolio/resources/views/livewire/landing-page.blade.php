            ...
            <div class="container mx-auto px-4">
                ...
                <div class="flex flex-wrap">
                    <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                        <div class="px-6">
                            <img alt="..." src="https://images.unsplash.com/photo-1541576980233-97577392db9a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjZ8fHByb2ZpbGUlMjBwaWN8ZW58MHwyfDB8fA%3D%3D&auto=format&fit=crop&w=800&h=800&q=60" class="shadow-lg rounded-full max-w-full mx-auto" style="max-width: 120px;"/>
                    ...
                    <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                        <div class="px-6">
                            <img alt="..." src="https://images.unsplash.com/photo-1489667897015-bf7a9e45c284?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTh8fHdvbWFufGVufDB8MnwwfHw%3D&auto=format&fit=crop&w=800&h=800&q=60" class="shadow-lg rounded-full max-w-full mx-auto" style="max-width: 120px;"/>
                            <div class="pt-6 text-center">
                    ...
                    <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                        <div class="px-6">
                            <img alt="..." src="https://images.unsplash.com/photo-1499887142886-791eca5918cd?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8d29tYW58ZW58MHwyfDB8fA%3D%3D&auto=format&fit=crop&w=800&h=800&q=60" class="shadow-lg rounded-full max-w-full mx-auto" style="max-width: 120px;"/>
                            <div class="pt-6 text-center">
                    ...
                    <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                        <div class="px-6">
                            <img alt="..." src="https://images.unsplash.com/photo-1597223557154-721c1cecc4b0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NzJ8fHdvbWFufGVufDB8MnwwfHw%3D&auto=format&fit=crop&w=800&h=800&q=60" class="shadow-lg rounded-full max-w-full mx-auto" style="max-width: 120px;"/>
                            <div class="pt-6 text-center">
